// LovaMe glossary: page-specific data and rendering.
const glossaryData = [
    {
        term: "推し",
        kana: "おし",
            ...
            <details>
                ...
                <div class="category-content">
                    ${catTerms.map(item => {
                        ...
                        const relatedUrl = item.category === '取引・グッズ交換' ? 'articles/' : '';
                        const relatedHtml = relatedUrl ? `<p class="term-related"><a href="${relatedUrl}">関連するグッズ交換ガイド →</a></p>` : '';
